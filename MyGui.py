...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.lbl_lastip_since_time.setGeometry(QtCore.QRect(410, 220, 51, 21))
        font = QtGui.QFont()
        font.setFamily("Roboto")
        font.setPointSize(8)
        font.setBold(False)
