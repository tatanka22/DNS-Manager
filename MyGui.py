...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.le_ip_tid = QtWidgets.QLineEdit(self.tab_main)
        self.le_ip_tid.setGeometry(QtCore.QRect(430, 340, 61, 20))
        self.le_ip_tid.setMaximumSize(QtCore.QSize(80, 16777215))
        font = QtGui.QFont()
        font.setFamily("Roboto")
        self.le_ip_tid.setFont(font)
        self.le_ip_tid.setWhatsThis("")
        self.le_ip_tid.setInputMethodHints(QtCore.Qt.ImhNone)
        self.le_ip_tid.setObjectName("le_ip_tid")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.le_ip_tid.setToolTip(_translate("MainWindow", "<html><head/><body><p>test</p></body></html>"))
