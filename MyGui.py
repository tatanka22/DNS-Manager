...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.tabWidget.setGeometry(QtCore.QRect(70, 40, 551, 681))
        ...
        self.lbl_lastip_since_date_val = QtWidgets.QLabel(self.tab_main)
        self.lbl_lastip_since_date_val.setGeometry(QtCore.QRect(470, 220, 71, 20))
        font = QtGui.QFont()
        font.setFamily("Roboto")
        ...
        self.tableView.setGeometry(QtCore.QRect(60, 50, 381, 211))
        self.tableView.setObjectName("tableView")
        self.btn_table = QtWidgets.QPushButton(self.tab)
        self.btn_table.setGeometry(QtCore.QRect(460, 40, 75, 23))
